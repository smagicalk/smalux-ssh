...
pub use channel::{
    ...
    authenticating_event, channel_error, channel_failure_parts, channel_reason_error,
    ...
    connection_error, disconnected_event, exit_status_to_i32, host_key_or_connection_error,
    host_key_rejected_error, host_key_verified_event, is_channel_failure, output_event,
    pty_columns, pty_rows, remote_command_started_event, shell_drain_should_stop,
...
pub use sftp::{
    ...
    sftp_entry_from_parts, sftp_error, sftp_failure_parts, sftp_io_error, transfer_event,
};
