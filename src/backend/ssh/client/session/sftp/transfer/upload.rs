...
use smagical_ssh_client_core::{
    UPLOAD_CLOSE_REMOTE_OPERATION, UPLOAD_OPEN_LOCAL_OPERATION, UPLOAD_OPEN_REMOTE_OPERATION,
    UPLOAD_READ_LOCAL_OPERATION, UPLOAD_STAT_LOCAL_OPERATION, UPLOAD_WRITE_REMOTE_OPERATION,
    copy_transfer_with_progress, parent_remote_dir, sftp_error, sftp_io_error, transfer_event,
};
...
impl RemoteSftp {
    pub(in super::super) async fn upload(
        &self,
        id: TransferId,
        local_path: String,
        remote_path: String,
